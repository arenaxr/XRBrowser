...
extension String {
    public static let AuthenticatorCancel = "Cancel"
    public static let AuthenticatorLogin = "Log in"
    public static let AuthenticatorPromptTitle = "Authentication required"
    public static let AuthenticatorPromptRealmMessage = "A username and password are being requested by %@. The site says: %@"
    public static let AuthenticatorPromptEmptyRealmMessage = "A username and password are being requested by %@."
    public static let AuthenticatorUsernamePlaceholder = "Username"
    public static let AuthenticatorPasswordPlaceholder = "Password"
}
